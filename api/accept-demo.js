...
export default async function handler(req, res) {
  ...
  // Token demo signé avec le secret TradingAI — valable 10 minutes
    ...
    html: `
      <div style="font-family:sans-serif;max-width:480px;margin:auto">
        ...
        <p style="margin-top:20px;color:#999;font-size:13px">
          Ce lien expire dans <strong>10 minutes</strong>. Ne le partagez pas.
        </p>
  ...
  // Page de confirmation pour Hassane
